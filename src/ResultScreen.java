 ...
 * Zeigt Auswertung, Zeitdiagramm und Namenseingabe für Highscore.
 */
public class ResultScreen extends JFrame {
    ...
    class ResultPanel extends JPanel implements ActionListener {
        ...
        public ResultPanel() {
            ...
            submitBtn = makeButton("🏆 Eintragen", 430, 455, 140, 38, new Color(80,30,160));
            submitBtn.addActionListener(e -> {
                if (!submitted) {
                    ...
                    submitted = true;
                    submitBtn.setText("✓ Eingetragen!");
                    submitBtn.setEnabled(false);
                }
            });
            add(submitBtn);

            playAgainBtn = makeButton("⚔ Nochmal", 140, 520, 160, 40, new Color(60,120,30));
            playAgainBtn.addActionListener(e -> { animTimer.stop(); dispose(); new GameScreen(); });
            add(playAgainBtn);

            scoreBtn = makeButton("🏆 Highscores", 320, 520, 160, 40, new Color(100,60,20));
            scoreBtn.addActionListener(e -> { animTimer.stop(); dispose(); new HighscoreScreen(); });
            add(scoreBtn);

            menuBtn = makeButton("🏠 Menü", 500, 520, 160, 40, new Color(40,40,100));
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2.drawString("📊 Auswertung", 75, 135);
            ...
            g2.setColor(Color.WHITE);
            g2.setFont(new Font("SansSerif", Font.PLAIN, 15));
            g2.drawString("Ø Bearbeitungszeit:", 75, 186);
            ...
            g2.setColor(new Color(200,170,255));
            g2.drawString("Name für Highscore:", 240, 450);
        }
        ...
        private void drawTimeChart(Graphics2D g2) {
            ...
            for (int i = 0; i < times.length; i++) {
                ...
                // Farbe: grün wenn korrekt, getrennter check nicht möglich ohne extra array
            ...
            g2.drawString("Ø", ox+w-22, avgY-2);
        }
